...
const getData = async () => {
    ...
    try {
        ...
        getDataFor5Days(lat, lon); // Adjusted function for 5-day forecast
    } catch (error) {
        console.log(error);
    }
};
...
function showWeatherData(data) {
    const { temp, humidity, pressure, wind_speed } = data.list[0].main; // Taking the first entry for current weather
